		...
		<div className="mt-3">
			...
			{all.length === 0 ? (
				<button
					type="button"
					onClick={openCreate}
					className="mx-1 mt-1 flex w-[calc(100%-8px)] items-center gap-[10px] rounded-[9px] border border-dashed border-[var(--border)] px-[12px] py-[9px] text-left transition-colors hover:border-[var(--border-active)]"
				>
