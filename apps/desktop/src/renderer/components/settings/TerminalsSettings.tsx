		...
		<div>
			...
			<div className="mb-6 flex flex-wrap gap-4 text-[12px]">
				<div className="flex items-center gap-1.5">
					<span className="text-[var(--text-quaternary)]">Daemon PTYs:</span>
					<span className="font-mono font-medium text-[var(--text-secondary)]">
						{daemon?.daemonSessions.length ?? "?"}
					</span>
				</div>
				<div className="flex items-center gap-1.5">
					<span className="text-[var(--text-quaternary)]">Active:</span>
					<span className="font-mono font-medium text-[#30d158]">
						{rows.filter((r) => r.status === "active").length}
					</span>
				</div>
				<div className="flex items-center gap-1.5">
					<span className="text-[var(--text-quaternary)]">Orphaned:</span>
					<span className="font-mono font-medium text-[#ffd60a]">{orphanCount}</span>
				</div>
				<div className="flex items-center gap-1.5">
					<span className="text-[var(--text-quaternary)]">DB rows:</span>
					<span className="font-mono font-medium text-[var(--text-secondary)]">
						{dbQuery.data?.sessions.length ?? "?"}
					</span>
				</div>
			</div>
